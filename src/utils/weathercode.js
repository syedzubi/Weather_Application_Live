...
const weathercode = (latitude,longitude, callback)=>{
  ...
  request({url,json:true}, (error,{body})=>{
    if(error){
      ...
      callback(undefined,
       "Current Weather is "+body.current.weather_descriptions[0]+" the temperature is "+body.current.temperature+" degrees and it feels like "+body.current.feelslike+" degrees out there"
      )
